...
const Auth: React.FC<AuthProps> = ({ onLogin, loading }) => {
  ...
  const termsContent = (
    <div className="space-y-3">
      <p><strong>제1조 (목적)</strong><br />본 약관은 Forteen AI(이하 "회사")가 제공하는 인공지능 채팅 서비스(이하 "서비스")의 이용 조건 및 절차를 규정합니다.</p>
      ...
      <div className="min-h-[100dvh] bg-[#F1F5F9] flex flex-col items-center justify-center p-4 md:p-10">
        ...
        <div className="mx-auto w-[280px] md:w-[680px] flex flex-col gap-5 md:gap-10">
          <button onClick={() => setView('student-auth')} className="group flex flex-col items-center p-8 md:p-14 bg-brand-900 rounded-[2rem] md:rounded-[3rem] shadow-2xl hover:shadow-brand-900/30 hover:-translate-y-2 transition-all text-center border border-slate-800 relative overflow-hidden">
            ...
            <h2 className="text-2xl md:text-4xl font-black text-white mb-3 md:mb-5">학생 시작하기</h2>
          ...
          <button onClick={() => setView('parent-auth')} className="group flex flex-col items-center p-8 md:p-14 bg-white rounded-[2rem] md:rounded-[3rem] shadow-2xl hover:shadow-slate-200 hover:-translate-y-2 transition-all text-center border border-white relative overflow-hidden">
            ...
            <h2 className="text-2xl md:text-4xl font-black text-slate-900 mb-3 md:mb-5">학부모 시작하기</h2>
